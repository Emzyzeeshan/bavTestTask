                    ...
                    child: Column(
                      children: [
                        _buildScreenTitle(
                          context,
                          screenTitle:
                              "Online Booking (Reject or Accept) - Tab Container"
                                  .tr,
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle:
                              "Sign up Screen (Enter your mobile Number Error Message)"
                                  .tr,
                          onTapScreenTitle: () => onTapScreenTitle(AppRoutes
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "Sign up page (OTP)".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.signUpPageOtpScreen),
                        ),
                      ],
                    ),
                  ),
